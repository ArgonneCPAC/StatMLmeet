...
if input_dim == 128: 
    ...
    read_data = np.load(dirIn + "0.049999999999999996.npy")[:1000, :]


    # read_data = read_data + 0.0001
    
    swe_data = np.log10(read_data+1)
    # swe_data = read_data
...
swe_train = swe_train.reshape(900,input_dim,input_dim,1)
swe_valid = swe_valid.reshape(100,input_dim,input_dim,1)
